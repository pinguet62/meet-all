        ...
        void ok() {
            ...
            when(providerFactory.getProviderService(TINDER)).thenAnswer(a -> {
                ...
                when(providerService.getConversations("tinderCredential_91")).thenReturn(Flux.just(
                        new ConversationDto("convTinder11", new LazyProfileDto("profTinder11", "profile name 11", "https://google.fr/favicon.png"), ZonedDateTime.of(2001, 4, 7, 9, 13, 37, 27, UTC), new LazyMessageDto(ZonedDateTime.of(2001, 4, 7, 9, 13, 37, 27, UTC), true, "message Tinder 11")),
                        new ConversationDto("convTinder12", new LazyProfileDto("profTinder12", "profile name 12", null), ZonedDateTime.of(2003, 8, 12, 5, 28, 56, 98, UTC), null)));
                return providerService;
            });
            when(providerFactory.getProviderService(HAPPN)).thenAnswer(a -> {
                ProviderService providerService = mock(ProviderService.class);
                when(providerService.getConversations("happnCredential_92")).thenReturn(Flux.just(
                        new ConversationDto("convHappn21", new LazyProfileDto("profHappn21", "profile name 21", null), ZonedDateTime.of(2002, 7, 9, 19, 52, 59, 12, UTC), new LazyMessageDto(ZonedDateTime.of(2002, 7, 9, 19, 52, 59, 12, UTC), false, "message Happn 21"))));
                return providerService;
            });
            ...
            assertThat(conversations, contains(
                    new ConversationDto("91#convTinder12", new LazyProfileDto("91#profTinder12", "profile name 12", null), ZonedDateTime.of(2003, 8, 12, 5, 28, 56, 98, UTC), null),
                    new ConversationDto("92#convHappn21", new LazyProfileDto("92#profHappn21", "profile name 21", null), ZonedDateTime.of(2002, 7, 9, 19, 52, 59, 12, UTC), new LazyMessageDto(ZonedDateTime.of(2002, 7, 9, 19, 52, 59, 12, UTC), false, "message Happn 21")),
                    new ConversationDto("91#convTinder11", new LazyProfileDto("91#profTinder11", "profile name 11", encode("https://google.fr/favicon.png")), ZonedDateTime.of(2001, 4, 7, 9, 13, 37, 27, UTC), new LazyMessageDto(ZonedDateTime.of(2001, 4, 7, 9, 13, 37, 27, UTC), true, "message Tinder 11"))));
        }
            ...
            StepVerifier.withVirtualTime(() -> {
                ...
                when(providerFactory.getProviderService(TINDER)).thenAnswer(a -> {
                    ...
                    when(providerService.getConversations("tinderCredential_91")).thenReturn(
                            Mono.delay(delay)
                                    .flatMapIterable(it -> List.of(new ConversationDto("convTinder11", new LazyProfileDto("profTinder11", "profile name 11", null), ZonedDateTime.of(2001, 4, 7, 9, 13, 37, 27, UTC), new LazyMessageDto(ZonedDateTime.of(2001, 4, 7, 9, 13, 37, 27, UTC), true, "message Tinder 11")))));
                    return providerService;
                });
                when(providerFactory.getProviderService(HAPPN)).thenAnswer(a -> {
                    ProviderService providerService = mock(ProviderService.class);
                    when(providerService.getConversations("happnCredential_92")).thenReturn(
                            Mono.delay(delay).flatMapIterable(it -> List.of(new ConversationDto("convHappn21", new LazyProfileDto("profHappn21", "profile name 21", null), ZonedDateTime.of(2002, 7, 9, 19, 52, 59, 12, UTC), new LazyMessageDto(ZonedDateTime.of(2002, 7, 9, 19, 52, 59, 12, UTC), false, "message Happn 21")))));
                    return providerService;
                });
